...
@interface LCViewPagerView ()<UIScrollViewDelegate,LCViewPagerImgViewDelegate>
@property (nonatomic, strong) UIScrollView *scrollView;
@property (nonatomic, strong) LCViewPagerImageView *curentImageView;
@property (nonatomic, strong) LCViewPagerImageView *nextImageView;
@property (nonatomic, strong) UIPageControl *pageControl;
@property (nonatomic, assign) NSInteger curentCount;
@end


@implementation LCViewPagerView
...
- (void)initImageViews
{
    self.curentImageView = [[LCViewPagerImageView alloc]initWithFrame:CGRectMake(self.curentCount * kScreemWidth, 0, kScreemWidth, self.frame.size.height)];
    self.curentImageView.delegate = self;
    [self.scrollView addSubview:self.curentImageView];
    
    self.nextImageView = [[LCViewPagerImageView alloc]initWithFrame:CGRectMake((self.curentCount + 1) * kScreemWidth, 0, kScreemWidth, self.frame.size.height)];
...
#pragma mark - LCViewPagerImgViewDelegate
